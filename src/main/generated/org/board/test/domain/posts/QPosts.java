...
public class QPosts extends EntityPathBase<Posts> {
    ...
    private static final long serialVersionUID = -490912264L;

    public static final QPosts posts = new QPosts("posts");

    public final org.board.test.domain.QBaseTimeEntity _super = new org.board.test.domain.QBaseTimeEntity(this);
